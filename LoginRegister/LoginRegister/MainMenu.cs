...
namespace LoginRegister
{
    public partial class MainMenu : Form
    {
        ...
        private void btnMehsullarSiyahi_Click(object sender, EventArgs e)
        {
            ...
            {
                dataGridView1.Rows.Add(mehsul.Id,mehsul.Name, markalars.First(mark => mark.Id == mehsul.Marka_Id).Name, kateqoriyalars.First(kat => kat.Id == mehsul.Kateqoriya_Id).Name);
            }
        }

        private void dataGridView1_RowHeaderMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            int silinecekMehsul = Convert.ToInt32(dataGridView1.Rows[e.RowIndex].Cells[0].Value);
